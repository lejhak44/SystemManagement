...
{
    public partial class tItemReturn
    {
        public tItemReturn()
        {
            tItemReturn_Detail = new HashSet<tItemReturn_Detail>();
        }
        ...
        public virtual ICollection<tItemReturn_Detail> tItemReturn_Detail { get; set; }
    }
}
