...
{
    public partial class tOpportunity
    {
        public tOpportunity()
        {
            tOpportunity_Detail = new HashSet<tOpportunity_Detail>();
        }
        ...
        public virtual ICollection<tOpportunity_Detail> tOpportunity_Detail { get; set; }
    }
}
