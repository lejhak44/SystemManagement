...
{
    public partial class tSalesEndorsement
    {
        public tSalesEndorsement()
        {
            tSalesEndorsement_Detail = new HashSet<tSalesEndorsement_Detail>();
        }
        ...
        public virtual ICollection<tSalesEndorsement_Detail> tSalesEndorsement_Detail { get; set; }
    }
}
