...
{
    public partial class tItemIssuance
    {
        public tItemIssuance()
        {
            tItemIssuance_Detail = new HashSet<tItemIssuance_Detail>();
        }
        ...
        public virtual ICollection<tItemIssuance_Detail> tItemIssuance_Detail { get; set; }
    }
}
