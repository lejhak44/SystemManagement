...
{
    public partial class tItemTransfer
    {
        public tItemTransfer()
        {
            tItemTransfer_Detail = new HashSet<tItemTransfer_Detail>();
        }
        ...
        public virtual ICollection<tItemTransfer_Detail> tItemTransfer_Detail { get; set; }
    }
}
