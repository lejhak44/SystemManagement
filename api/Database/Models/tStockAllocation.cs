...
{
    public partial class tStockAllocation
    {
        public tStockAllocation()
        {
            tStockAllocation_Detail = new HashSet<tStockAllocation_Detail>();
        }
        ...
        public virtual ICollection<tStockAllocation_Detail> tStockAllocation_Detail { get; set; }
    }
}
