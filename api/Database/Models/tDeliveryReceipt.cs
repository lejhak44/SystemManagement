...
{
    public partial class tDeliveryReceipt
    {
        public tDeliveryReceipt()
        {
            tDeliveryReceipt_Detail = new HashSet<tDeliveryReceipt_Detail>();
        }
        ...
        public virtual ICollection<tDeliveryReceipt_Detail> tDeliveryReceipt_Detail { get; set; }
    }
}
