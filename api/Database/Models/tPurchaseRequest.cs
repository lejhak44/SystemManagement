...
namespace ngJSApp.Database.Models
{
    ...
    {
        public tPurchaseRequest()
        {
            tPurchaseRequest_Detail = new HashSet<tPurchaseRequest_Detail>();
        }
        ...
        public virtual ICollection<tPurchaseRequest_Detail> tPurchaseRequest_Detail { get; set; }
    }
}
