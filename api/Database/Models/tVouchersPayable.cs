...
{
    public partial class tVouchersPayable
    {
        public tVouchersPayable()
        {
            tVouchersPayable_Detail = new HashSet<tVouchersPayable_Detail>();
        }
        ...
        public virtual ICollection<tVouchersPayable_Detail> tVouchersPayable_Detail { get; set; }
    }
}
