...
{
    public partial class tOpeningBalance
    {
        public tOpeningBalance()
        {
            tOpeningBalance_Detail = new HashSet<tOpeningBalance_Detail>();
        }
        ...
        public virtual ICollection<tOpeningBalance_Detail> tOpeningBalance_Detail { get; set; }
    }
}
