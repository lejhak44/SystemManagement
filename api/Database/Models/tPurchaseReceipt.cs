...
{
    public partial class tPurchaseReceipt
    {
        public tPurchaseReceipt()
        {
            tPurchaseReceipt_Detail = new HashSet<tPurchaseReceipt_Detail>();
        }
        ...
        public virtual ICollection<tPurchaseReceipt_Detail> tPurchaseReceipt_Detail { get; set; }
    }
}
