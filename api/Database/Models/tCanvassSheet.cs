...
{
    public partial class tCanvassSheet
    {
        public tCanvassSheet()
        {
            tCanvassSheet_Detail = new HashSet<tCanvassSheet_Detail>();
        }
        ...
        public virtual ICollection<tCanvassSheet_Detail> tCanvassSheet_Detail { get; set; }
    }
}
